...
useEffect(()=>{
  ...
  return (
    <div id={`video-${id}`} className=' bg-foreground text-background h-screen containt overflow-hidden relative justify-center pt-5 gap-4 block sm:flex'>
      <section ref={ref} id='foryou-id' className=' px-5 md:px-0 relative w-full sm:w-[419px]'>
        ...
        <div className=' w-11/12 absolute bottom-11 space-y-1 left-3'>
         ...
         <div className=' absolute z-50 top-1/2 -translate-y-1/2 md:translate-y-0 right-5 md:right-0 md:relative md:-top-5 flex flex-col gap-4 items-center justify-end'>
          {/* author follow */}
