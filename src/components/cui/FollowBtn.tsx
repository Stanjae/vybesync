...
const FollowBtn = ({celebrityId, userId}:{userId:string;celebrityId:string}) => {
    ...
    return (
        <Button onClick={handleFollow} size={'lg'} className={`${isFollowing ? 
            "bg-muted-custom border text-primary-custom border-primary-custom" :"bg-primary-custom text-background"} `}>
