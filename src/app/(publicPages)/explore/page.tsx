...
const page = async({searchParams}:{searchParams: Promise<SearchParams>}) => {
  ...
  return (
    <div id='explorePage' className=' h-dvh overflow-y-scroll! bg-foreground space-y-3 w-full relative'>
      <div className=' bg-foreground pt-5 fixed top-0 z-10'>
        <h1 className='text-xl font-bold'>You may like</h1>
        <CategoryCarousel/>
      </div>
        
        <Suspense fallback={<div className=' flex justify-center items-center'><CLoader/></div>}>
